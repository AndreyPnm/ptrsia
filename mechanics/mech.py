...
def getd(arg1, arg2, arg3, arg4, tau):
    return (arg1 + 2 * arg2 + 2 * arg3 + arg4) * tau / 6
...
def one_step_runge_kutta(theta1, theta2, omega1, omega2):
    ...
    dtheta1 = getd(k1theta1, k2theta1, k3theta1, k4theta1, tau)
    dtheta2 = getd(k1theta2, k2theta2, k3theta2, k4theta2, tau)
    domega1 = getd(k1omega1, k2omega1, k3omega1, k4omega1, tau)
    domega2 = getd(k1omega2, k2omega2, k3omega2, k4omega2, tau)
...
omega1 = 0
omega2 = 0
print("t", t, "theta1", theta1, "theta2", theta2, "omega1", omega1, "omega2", omega2)
